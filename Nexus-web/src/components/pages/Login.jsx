...
import { LuLayers, LuShieldCheck, LuLock, LuMail, LuActivity } from 'react-icons/lu';
...
const Login = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      const res = await axios.post(`${BASE_URL}/auth/google`, null, {
      ...
      <div className="w-full max-w-[420px] animate-in fade-in zoom-in duration-500">
        ...
        <div className="text-center mb-10 space-y-3">
          ...
          <div className="flex items-center justify-center gap-2 opacity-50">
            <LuShieldCheck size={12} className="text-blue-500" />
            <span className="text-[10px] font-black uppercase tracking-[0.2em] dark:text-slate-400">Terminal Authentication</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#0b101b] border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl shadow-slate-200/50 dark:shadow-none">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-white dark:bg-[#0b101b] text-[10px] font-black text-slate-400 uppercase tracking-widest">Global SSO</span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center">
          <span className="text-xs font-bold text-slate-400 uppercase tracking-tight">New to the Terminal?</span>
          <Link to="/register" className="ml-2 text-xs font-black text-blue-600 uppercase tracking-widest hover:underline decoration-2 underline-offset-4">
            Register Node
          </Link>
        </p>
      </div>
